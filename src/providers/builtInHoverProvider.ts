...
export class BuiltInHoverProvider implements vscode.HoverProvider {
  builtItems!: Map<string, BuiltItem>

  items: Array<BuiltItem>
  ...
  provideHover(document: vscode.TextDocument, position: vscode.Position): vscode.ProviderResult<vscode.Hover> {
    ...
    let item = this.builtItems.get(globalFun)
    if (!item) {
      item = this.builtItems.get(document.getText(range))!
    }
